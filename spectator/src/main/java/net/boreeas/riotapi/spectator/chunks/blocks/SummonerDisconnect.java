...
@Value
@Log4j
@IsBlock(BlockType.SUMMONER_DISCONNECT)
public class SummonerDisconnect extends Block {
    private long entityId;

    public SummonerDisconnect(BlockHeader header, byte[] data) {
        super(header, data);
        ...
        log.warn("[SUMMONER_DISCONNECT] unk1 = " + unk1);
