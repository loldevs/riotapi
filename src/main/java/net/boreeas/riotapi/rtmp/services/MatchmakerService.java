...
public class MatchmakerService {
    ...
    /**
     * Attaches the user to the specified queues
     * @param params The queue specifications
     * @return
     */
    public SearchingForMatchNotification attachToQueues(MatchMakerParams params) {
        return client.sendRpcAndWait(SERVICE, "attachToQueues", params);
    }
    ...
    public SearchingForMatchNotification attachTeamToQueues(MatchMakerParams params) {
        return client.sendRpcAndWait(SERVICE, "attachTeamToQueues", params);
    }
